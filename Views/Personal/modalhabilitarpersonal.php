<div class="modal fade" id="habilitarpersonalModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
               <div class="modal-body" style="padding-top:0;padding-bottom:0;z-index:20">
				<div class="row">
	                   	...
	                   	<div class="col-md-8">
	                       	<center><h3 style="margin-top:35px;color: #1cd2dc;font-weight: 700;">HABILITAR PERSONA</h3></center>
					   	<form autocomplete="off">
							<div class="form-group" style="margin-bottom:20px">
	                                	<label style="color:#3fd2e0;font-weight:400;font-family:arial;font-size:.8em;margin-bottom:2px">CAJA</label>
                                        <div class="input-group">
								<select id="selecthabilitar" class="form-control selectpicker show-tick" data-live-search="true">
	                            	...
	                            	<center>
	                                	<button class="btn btn-success btn-lg" style="margin:10px 0 18px 0px" id="buttonhabilitar" type="button" disabled>HABILITAR PERSONA</button>
	                            	</center>
						</form>
	                   	</div>
				</div>
