...
<div class="row">
		<h2 class="text-center" style="margin:20px 0 1px 0;font-weight:300">LISTA DEL PERSONAL DE POTOSÍ</h2>
</div>
				...
				<div class="row" id="alert_empty"> <!-- SECTION EMPTY TABLE -->
					<?php if(count($resultado["personal"])<1):?>
						<div class="col-md-12">
							...
							<strong>MENSAJE DE ALERTA!</strong> No se encontró PERSONAL registrados.
							</div>
						</div>
					<?php endif;?>
				</div>
		...
		success:function(obj){
			...
			if (obj=="ci") {
				...
				if (obj=="codigo") {
					...
					setInterval(function(){ window.location.href = "/Personal"; }, 1000);
				}
			}}});});
