<div class="modal fade" id="updatecajaModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer" style="padding:5px 0 5px 0">
				<a  onclick="bajaAjax()"><button title="eliminar caja" type="button" id="btneliminar_u" class="btn btn-danger btn-sm">Emininar Caja</button></a>
